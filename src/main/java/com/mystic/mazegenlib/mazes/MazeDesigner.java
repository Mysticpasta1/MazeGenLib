...
import com.mystic.mazegenlib.core.SectionData;
import com.mystic.mazegenlib.core.math.DirectedGraph;
import com.mystic.mazegenlib.core.math.DisjointSet;
...
public class MazeDesigner
{
    ...
    private static void splitByRandomX(PartitionNode node, int levels, Random random)
    {
        ...
        {
            node.splitByX(MathHelper.nextInt(random,
    ...
    private static void splitByRandomZ(PartitionNode node, int levels, Random random)
    {
        ...
        {
            node.splitByZ(MathHelper.nextInt(random,
    ...
    private static void splitByRandomY(PartitionNode node, int levels, Random random)
    {
        ...
        {
            node.splitByY(MathHelper.nextInt(random,
